        ...
        <div className="wrapper">
          <section className="upload-form">
            ...
            <div className="input-field">
              <form className="uploadbtn">
                <input className="upload-input" type="file" id="myFile" name="filename" accept="image/*"></input>
          ...
          <section className="additem-form">
            <div className="input-field">
              ...
              <input
                name="itemname" id="itemname" type="text" placeholder="ชื่อสินค้า"/>
            </div><br></br>
            ...
            <div className="input-field">
              ...
              <input name="description" id="description" type="text" placeholder="คำอธิบายสินค้า"/>
            </div><br></br>
            ...
            <div className="input-field">
              ...
              <input name="price" id="price" type="number" placeholder="ex. 250" min="0"/>
            </div><br></br>
            ...
            <div className="input-field">
                ...
                <div className="optionfield">
                  ...
                  <label className="optionlabel">
                    <select className="optionselect" id="category2" name="className" >
                  ...
                  <label className="optionlabel">
                    <select className="optionselect" id="category3" name="category" >
            ...
            <div className="input-field">
              <label htmlFor="tags"><h3>Tags (comma-separated)</h3></label>
              <input type="text" id="tags" name="tags" required></input>
            </div><br></br>

            <label htmlFor="variants"><h3>Variants</h3></label>
              <button className="variantbtn" type="button" id="addVariant">Add Variant</button>
