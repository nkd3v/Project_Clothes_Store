...
VALUES
    ...
    ('XS', 'GRAY', '#7F888F', 1290, 18, '27-gray.avif', (SELECT id FROM Products WHERE name = 'เสื้อแจ็คเก็ต ผ้าฟลีซ มีซิป แขนยาว'), datetime('now'), datetime('now')),
    ('S', 'BLUE', '#0D4488', 1290, 18, '27-blue.avif', (SELECT id FROM Products WHERE name = 'เสื้อแจ็คเก็ต ผ้าฟลีซ มีซิป แขนยาว'), datetime('now'), datetime('now')),
